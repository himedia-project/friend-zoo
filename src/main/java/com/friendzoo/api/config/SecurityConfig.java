package com.friendzoo.api.config;
...
//        configuration.setAllowedOriginPatterns(Arrays.asList("*"));  // localhost:3000 -> 허용
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost:3001", "http://43.200.239.220", "https://openapi.map.naver.com"));
        // 허용할 메서드 설정
