...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public PageResponseDTO<OrderHistDTO> list(AdminOrderController.OrderHisRequestDTO pageRequestDTO) {
        log.info("list..............");

        Page<Order> result = orderQuerydslRepository.findAllBy(pageRequestDTO);
